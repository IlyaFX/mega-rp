...
import ru.atlant.roleplay.invs.content.InventoryContents;
import ru.atlant.roleplay.invs.content.InventoryProvider;
import ru.atlant.roleplay.invs.opener.InventoryOpener;
...
public class SmartInventory {
    ...
    private InventoryModule manager;

    private SmartInventory(InventoryModule manager) {
    ...
    public InventoryModule getManager() {
        return manager;
    }
    ...
    public static final class Builder {
        ...
        public SmartInventory build() {
            ...
            InventoryModule manager = RolePlay.getInstance().getRegistry().get(InventoryModule.class);
